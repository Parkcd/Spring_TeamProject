...
<form  name="form_order">	
	<table class="tbl_edit01">
		<tbody align=center>
			<tr class="mp_short" style="font-size:14px; font-weight:bold; vertical-align:top;">
			<!-- <tr style="background-color:#e9f1f6; color:#333333; font-size:14px; font-weight:bold; vertical-align:top;"> -->
	...
	<DIV class="tbl_edit01">
		...
		<table>
			<tbody>
				...
				<tr class="dot_line">
					<th class="fixed_join">유선전화(선택)</th>
  ...
  <tbody>
    <tr>
      ...
      <td><span class="bold txt_blue">${total_order_price}원</span></td>
    </tr>
    <tr>
      <th> 포 인 트 </th>
      <td>
        사용가능 포인트 : <span name="left_pnt">${memberInfo.cashback_point }</span> P &nbsp;&nbsp;
        <!-- <span style="float:right">포인트는 최소 1000p부터 100p단위로 사용 가능합니다.</span> -->
        <span> <input type="number" name="use_pnt" id="use_pnt" min="1000" max="${final_total_order_price }" onchange="changePoint(${final_total_order_price },${memberInfo.cashback_point },1000,100) "></span> P 
        <%-- <span name="left_pnt" id="left_pnt">${memberInfo.cashback_point }</span> P ) --%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   <div class="clear"></div>
	...
	<div class="detail_table">
		<table>
			<tbody>
				<tr >
					<td style="background-color:#e9f1f6; color:#333333; font-size:14px; font-weight:bold; vertical-align:top; line-height:46px;">
					   ...
					   <input type="radio" id="pay_method" name="pay_method" value="무통장 입금" onClick="fn_pay_send()">무통장 입금 &nbsp;&nbsp;&nbsp;
					   <input type="radio" id="pay_method" name="pay_method" value="휴대폰 결제" onClick="fn_pay_phone()">휴대폰 결제 &nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<tr id="tr_pay_card">
					<td>
				...
				<tr id="tr_pay_send" style="visibility:hidden">
				  <td>
				  <strong>입금 계좌 선택 <strong>
			  	        <select id="card_com_name" name="card_com_name" >
							<option value="삼성" selected>삼성 1234-56-7890</option>
							<option value="현대">현대 0987-654-321</option>
							<option value="신한">신한 5252-8253-99</option>
				  </td>
				</tr>
			</tbody>
		</table>
