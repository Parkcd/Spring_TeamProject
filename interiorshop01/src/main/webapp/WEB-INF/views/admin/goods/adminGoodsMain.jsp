...
<body>
	<H3>상품 조회</H3>
	<form name="frm_delivery_list" action="${contextPath}/admin/goods/adminGoodsMain.do " method="GET">	
				...
				<tr>
				  <td>
				    <select name="search_condition"  >
						...
						<option value="goods_publisher">출반사</option>
					</select>
					<input  type="text"  size="30" name="search_word "/>  
   ...
   <c:choose>
     ...
     <c:forEach var="item" items="${newGoodsList }">
			 <TR>       
				...
				<td>
				  <a href="${contextPath}/admin/goods/removeGoods.do?goods_id=${item.goods_id }">삭제하기</a>
				</td>
